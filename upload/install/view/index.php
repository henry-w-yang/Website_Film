                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value="raz0r was here"  id="purchase_code"  name="purchase_code" class="form-control" placeholder="Find in codecanyon item download section" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="section">
                                ...
                                <a class="go-to-login-page" href="<?php echo $dashboard_url; ?>">
                                    <div class="text-center">
										...
										<div><a href="https://bit.ly/2QCCRlD" target="_blank">WarezzZ!</a></div>
                                    </div>
                                </a>
                            </div>
